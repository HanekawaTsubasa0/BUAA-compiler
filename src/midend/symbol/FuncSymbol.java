...
public class FuncSymbol extends Symbol {
    ...
    private boolean ignoreParamCheck = false;
    public void setIgnoreParamCheck(boolean b) { this.ignoreParamCheck = b; }
    public boolean shouldIgnoreParamCheck() { return this.ignoreParamCheck; }
}
