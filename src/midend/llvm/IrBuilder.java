...
public class IrBuilder {
    ...
    public static void BeginFunction(IrFunction irFunction) {
        currentFunction = irFunction;
        if (currentModule != null && !currentModule.HasFunctionName(irFunction.GetIrName())) {
            currentModule.AddIrFunction(irFunction);
        }
        IrBasicBlock irBasicBlock = GetNewBasicBlockIr();
        currentBasicBlock = irBasicBlock;
    ...
    public static String GetFuncName(String name) {
        if (name.equals("main") || name.equals("getint") || name.equals("putint") || name.equals("putch") || name.equals("putstr")) {
            return "@" + name;
        }
