...
public class IrConstantArray extends IrConstant {
    ...
    public IrConstant GetElement(int index) {
        if (index >= 0 && index < this.valueList.size()) {
            return this.valueList.get(index);
        }
        // Zero padding implicit?
        // Or throw?
        // For partial initialization, the list might be shorter than size.
        // Assuming 0 for out of bounds of valueList but within arraySize?
        // The toString handles padding with "0".
        // I should return IrConstantInt(0).
